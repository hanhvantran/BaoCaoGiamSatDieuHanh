...
//console.log('mapDataWorld123:', mapDataWorld);
...
class ChartWeb extends Component {
            ...
            init:`<html>
                    ...
                    <script>
                        $(function () {
                            ...
                            Highcharts.mapChart('container', `, end:`);
                        });
                        </script>
                    </head>
                    <body>
 ...
 reRenderWebView(e) {
    ...
    render() {
       ...
       //  console.log(' config.series.mapData:', config);
       // let concatHTML = `${this.state.init}`;
              //let concatHTML = `${this.state.init}`;
        ...
        return (
          <View style={this.props.style}>
              <WebView
                  ...
                  style={styles.full}
                  source={{ html: concatHTML.toString(), baseUrl: 'web/' }}
