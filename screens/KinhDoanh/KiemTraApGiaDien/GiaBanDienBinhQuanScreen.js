...
export default class ThanhPhanPhuTaiScreen extends React.PureComponent {
  ...
  render() {
    ...
    let listGiaBanTheoNam=[];
    if( this.state.listGetGBBQThucHienTheoNam &&
      !Array.isArray(this.state.listGetGBBQThucHienTheoNam)
        )
        {    
          listGiaBanTheoNam.push(this.state.listGetGBBQThucHienTheoNam.Series[0]);
