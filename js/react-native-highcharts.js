    ...
    this.state = {
      init: `<html>
                    ...
                    <head>
                        ...
                        ${
                          this.props.stock
                            ? '<script src="http://10.170.0.5/Highcharts/highstock.js"></script>'
                            : '<script src="http://10.170.0.5/Highcharts/highcharts.js"></script>'
                        }
                        ${
                          this.props.more
                            ? '<script src="http://10.170.0.5/Highcharts/highcharts-more.js"></script>'
                            : ""
                        }
                        ${
                          this.props.guage
                            ? '<script src="http://10.170.0.5/Highcharts/solid-gauge.js"></script>'
                            : ""
                        }
