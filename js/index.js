    ...
    constructor(props){
        ...
        this.state={
            init:`<html>
                    ...
                    <head>
                        <script src="http://10.170.0.5/Highcharts/jquery-2.1.4.min.js"></script>
                        ${this.props.stock ? '<script src="http://10.170.0.5/Highcharts/highstock.js"></script>'
                                      : '<script src="http://10.170.0.5/Highcharts/highcharts.js"></script>'}
                        ${this.props.more ? '<script src="http://10.170.0.5/Highcharts/highcharts-more.js"></script>'
                                      : ''}
                        ${this.props.guage ? '<script src="http://10.170.0.5/Highcharts/solid-gauge.js"></script>'
                                      : ''}
                        <script src="http://10.170.0.5/Highcharts/exporting.js"></script>
                        <script>
                        $(function () {
